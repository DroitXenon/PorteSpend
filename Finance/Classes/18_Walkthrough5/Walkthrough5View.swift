...
class Walkthrough5View: UIViewController {
	...
	func loadCollections() {
		...
		dict1["description1"] = "Easily create budgets, and see our suggestions based on your spending."
		dict1["feature2"] = "Feature #2"
		dict1["description2"] = "We bring all of your money to one place, from balances and bills to credit score and more."
