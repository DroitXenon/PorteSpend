...
//-----------------------------------------------------------------------------------------------------------------------------------------------
class Comments2Cell1: UITableViewCell {
	...
	override func awakeFromNib() {
		...
		tableView.register(UINib(nibName: "Comments2Cell2", bundle: Bundle.main), forCellReuseIdentifier: "Comments2Cell2")
	}
	...
	func bindData(index: Int, data: [String: Any]) {
		...
		imageUserProfile.sample("Social", "Profiles", index + 5)
		...
		if let otherComments = data["otherComments"] as? [String: Any] {
			...
			viewSeeAllReplay.isHidden = false
			tableView.isHidden = false
			refreshTableView()
		}
		else {
			comments.removeAll()
			viewSeeAllReplay.isHidden = true
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension Comments2Cell1: UITableViewDataSource {
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		...
		let cell = tableView.dequeueReusableCell(withIdentifier: "Comments2Cell2", for: indexPath) as! Comments2Cell2
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension Comments2Cell1: UITableViewDelegate {
