...
//-----------------------------------------------------------------------------------------------------------------------------------------------
class Comments2Cell2: UITableViewCell {
	...
	func bindData(index: Int, data: [String: Any]) {
		...
		imageUserProfile.sample("Social", "Profiles", index + 15)
		...
		DispatchQueue.main.async {
			if let descriptionHeight = self.labelDescription.text?.height(withConstrainedWidth: self.labelDescription.frame.size.width, font: UIFont.systemFont(ofSize: 14)) {
