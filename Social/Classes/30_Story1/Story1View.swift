...
//-----------------------------------------------------------------------------------------------------------------------------------------------
class Story1View: UIViewController {
	...
	override func viewDidLoad() {
		...
		collectionView.register(UINib(nibName: "Story1Cell1", bundle: Bundle.main), forCellWithReuseIdentifier: "Story1Cell1")
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension Story1View: UICollectionViewDataSource {
	...
	func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
		...
		let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "Story1Cell1", for: indexPath) as! Story1Cell1
		cell.ViewSafeAreaInsets = self.view.safeAreaInsets
		cell.bindData(data: stories[indexPath.row])
		cell.buttonEmoji.addTarget(self, action: #selector(actionEmoji(_:)), for: .touchUpInside)
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension Story1View: UICollectionViewDelegate {
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension Story1View: UICollectionViewDelegateFlowLayout {
