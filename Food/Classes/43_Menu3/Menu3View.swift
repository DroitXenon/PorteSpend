...
//-----------------------------------------------------------------------------------------------------------------------------------------------
class Menu3View: UIViewController {
	...
	override func viewDidLoad() {
		...
		collectionViewMenu.register(UINib(nibName: "Menu3Cell1", bundle: Bundle.main), forCellWithReuseIdentifier: "Menu3Cell1")
		collectionViewProducts.register(UINib(nibName: "Menu3Cell2", bundle: Bundle.main), forCellWithReuseIdentifier: "Menu3Cell2")
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension Menu3View: UICollectionViewDataSource {
	...
	func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
		...
		if (collectionView == collectionViewMenu) {
			let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "Menu3Cell1", for: indexPath) as! Menu3Cell1
		...
		if (collectionView == collectionViewProducts) {
			let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "Menu3Cell2", for: indexPath) as! Menu3Cell2
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension Menu3View: UICollectionViewDelegate {
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension Menu3View: UICollectionViewDelegateFlowLayout {
	...
	func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
		...
		if (collectionView == collectionViewProducts) {
			return CGSize(width: (collectionView.frame.size.width-30), height: 250)
		}
