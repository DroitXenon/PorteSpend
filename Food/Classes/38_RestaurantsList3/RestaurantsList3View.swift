...
//-----------------------------------------------------------------------------------------------------------------------------------------------
class RestaurantsList3View: UIViewController {
	...
	override func viewDidLoad() {
		...
		collectionView.register(UINib(nibName: "RestaurantsList3Cell", bundle: Bundle.main), forCellWithReuseIdentifier: "RestaurantsList3Cell")
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension RestaurantsList3View: UICollectionViewDataSource {
	...
	func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
		...
		let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "RestaurantsList3Cell", for: indexPath) as! RestaurantsList3Cell
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension RestaurantsList3View: UICollectionViewDelegate {
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension RestaurantsList3View: UICollectionViewDelegateFlowLayout {
