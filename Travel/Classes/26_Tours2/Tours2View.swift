...
//-----------------------------------------------------------------------------------------------------------------------------------------------
class Tours2View: UIViewController {
	...
	override func viewDidLoad() {
		...
		tableView.register(UINib(nibName: "Tours2Cell", bundle: nil), forCellReuseIdentifier: "Tours2Cell")
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension Tours2View: UITableViewDataSource {
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		...
		let cell = tableView.dequeueReusableCell(withIdentifier: "Tours2Cell", for: indexPath) as! Tours2Cell
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension Tours2View: UITableViewDelegate {
