...
class Settings2View: UIViewController {
	...
	func loadData() {
		...
		var section4Settings: [[String: Any]] = []
		var section4Dict: [String: Any] = [:]
		...
		dict9["title"] = "Twitter"
		dict9["isSwitch"] = true
		section4Settings = [dict8, dict9]

		section4Dict["title"] = "SOCIAL"
		section4Dict["data"] = section4Settings

		settings = [section1Dict, section2Dict, section3Dict, section4Dict]
