...
class Walkthrough4View: UIViewController {
	...
	func loadCollections() {
		...
		dict1["title"] = "Discover places, hotels & news"
		...
		dict2["title"] = "Feel the nature"
		dict2["description"] = "It is those feelings that drive our love of astronomy and our desire to learn more and more about it. "
