...
class Walkthrough2View: UIViewController {
	...
	func loadCollections() {
		...
		dict1["title"] = "Discover new music"
		dict1["description"] = "It is those feelings that drive our love of collection and our desire to learn more and more about it. "
		collections.append(dict1)

		var dict2: [String: String] = [:]
		dict2["title"] = "Music for every mood"
		dict2["description"] = "It is those feelings that drive our love of collection and our desire to learn more and more about it. "
