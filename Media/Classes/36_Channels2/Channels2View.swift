...
//-----------------------------------------------------------------------------------------------------------------------------------------------
class Channels2View: UIViewController {
	...
	override func viewDidLoad() {
		...
		tableView.register(UINib(nibName: "Channels2Cell", bundle: nil), forCellReuseIdentifier: "Channels2Cell")
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension Channels2View: UITableViewDataSource {
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		...
		let cell = tableView.dequeueReusableCell(withIdentifier: "Channels2Cell", for: indexPath) as! Channels2Cell
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension Channels2View: UITableViewDelegate {
