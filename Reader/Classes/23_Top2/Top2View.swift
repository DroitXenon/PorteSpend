...
//-----------------------------------------------------------------------------------------------------------------------------------------------
class Top2View: UIViewController {
	...
	override func viewDidLoad() {
		...
		tableView.register(UINib(nibName: "Top2Cell", bundle: Bundle.main), forCellReuseIdentifier: "Top2Cell")
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension Top2View: UITableViewDataSource {
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		...
		let cell = tableView.dequeueReusableCell(withIdentifier: "Top2Cell", for: indexPath) as! Top2Cell
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension Top2View: UITableViewDelegate {
