...
//-----------------------------------------------------------------------------------------------------------------------------------------------
class Posts5View: UIViewController {
	...
	override func viewDidLoad() {
		...
		collectionView.register(UINib(nibName: "Posts5Cell", bundle: Bundle.main), forCellWithReuseIdentifier: "Posts5Cell")
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension Posts5View: UICollectionViewDataSource {
	...
	func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
		...
		let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "Posts5Cell", for: indexPath) as! Posts5Cell
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension Posts5View: UICollectionViewDelegate {
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension Posts5View: UICollectionViewDelegateFlowLayout {
