...
//-----------------------------------------------------------------------------------------------------------------------------------------------
class Profile3View: UITableViewController {
	...
	func loadData() {
		...
		imageUser.sample("Reader", "News", 15)
		labelUsername.text = "New York Times"
		labelUserInfo.text = "The Telegraph"
		labelPosts.text = "9697"
		labelFollowers.text = "29M"
		labelFollowing.text = "45"
