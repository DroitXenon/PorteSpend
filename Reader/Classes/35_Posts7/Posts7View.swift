...
//-----------------------------------------------------------------------------------------------------------------------------------------------
class Posts7View: UIViewController {
	...
	override func viewDidLoad() {
		...
		tableView.register(UINib(nibName: "Posts7Cell", bundle: Bundle.main), forCellReuseIdentifier: "Posts7Cell")
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension Posts7View: UITableViewDataSource {
	...
	func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
		...
		let cell = tableView.dequeueReusableCell(withIdentifier: "Posts7Cell", for: indexPath) as! Posts7Cell
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension Posts7View: UITableViewDelegate {
