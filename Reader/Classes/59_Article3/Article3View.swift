...
//-----------------------------------------------------------------------------------------------------------------------------------------------
class Article3View: UIViewController {
	...
	func loadData() {
		...
		imageNews.sample("Reader", "Technology", 17)
		imageUser.sample("Social", "Profiles", 10)
...
//-----------------------------------------------------------------------------------------------------------------------------------------------
extension Article3View: UIScrollViewDelegate {
	...
	func scrollViewDidScroll(_ scrollView: UIScrollView) {
		...
		if scrollView.tag == 11 {
			if let navController = navigationController as? NavigationController {
				if (scrollView.contentOffset.y > imageNews.frame.size.height*0.8) {
